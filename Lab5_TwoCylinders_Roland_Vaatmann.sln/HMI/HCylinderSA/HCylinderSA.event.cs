...
namespace HMI.Main.Symbols.HCylinderSA
{
  partial class HMI
  {
    ...
    private event EventHandler<Symbols.HCylinderSA.INDEventArgs> IND_Fired;
    ...
    protected override void FireEventCallback(int channelId, int cookie, int eventIndex)
    {
      switch(eventIndex)
      {
        ...
        case 0:
          if (IND_Fired != null)
            IND_Fired(this, new Symbols.HCylinderSA.INDEventArgs(channelId, cookie, eventIndex));
        break; 
