...
namespace HMI.Main.Symbols.HCylinder
{
  partial class HMI
  {
    ...
    private event EventHandler<Symbols.HCylinder.INDEventArgs> IND_Fired;
    ...
    protected override void FireEventCallback(int channelId, int cookie, int eventIndex)
    {
      switch(eventIndex)
      {
        ...
        case 0:
          if (IND_Fired != null)
            IND_Fired(this, new Symbols.HCylinder.INDEventArgs(channelId, cookie, eventIndex));
        break; 
...
namespace HMI.Main.Controllers.HCylinder
{
  partial class FacePlate01
  {
    ...
    protected override void FireEventCallback(int channelId, int cookie, int eventIndex)
    {
      switch(eventIndex)
      {
        ...
        case 0:
          if (IND_Fired != null)
            IND_Fired(this, new HMI.Main.Symbols.HCylinder.INDEventArgs(channelId, cookie, eventIndex));
        break; 
