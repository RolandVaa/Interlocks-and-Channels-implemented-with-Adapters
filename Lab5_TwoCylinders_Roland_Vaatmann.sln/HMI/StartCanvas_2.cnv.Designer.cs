...
this.currentUser1 = new NxtControl.GuiFramework.CurrentUser();
      ...
      this.canvasTopologySeparator2.Bounds = new NxtControl.Drawing.RectF(((float)(480)), ((float)(0)), ((float)(2)), ((float)(80)));
      ...
      this.canvasTopologyRose.LookAndFeel = "Dark";
      ...
      this.workArea.Size = new System.Drawing.Size(600, 520);
      ...
      this.header1.Bounds = new NxtControl.Drawing.RectF(((float)(0)), ((float)(0)), ((float)(600)), ((float)(80)));
      ...
      this.header1.ImageStream = ((System.IO.MemoryStream)(resources.GetObject("header1.ImageStream")));
    //
    // siblingsPanel
    //
    ...
    this.siblingsPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(0)), ((float)(281)), ((float)(80)));
    ...
    this.siblingsPanel.LookAndFeel = "Dark";
    ...
    this.childrenPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(39)), ((float)(281)), ((float)(80)));
    ...
    this.childrenPanel.LookAndFeel = "Dark";
    ...
    this.childrenPanel.EndInit();
      ...
      this.exit1.Bounds = new NxtControl.Drawing.RectF(((float)(560)), ((float)(0)), ((float)(40)), ((float)(40)));
      this.exit1.Text = "";
      this.exit1.Radius = 0;
      this.exit1.LookAndFeel = "Dark";
      ...
      this.login1.Bounds = new NxtControl.Drawing.RectF(((float)(480)), ((float)(0)), ((float)(40)), ((float)(40)));
      this.login1.Text = "";
      ...
      this.language1.Bounds = new NxtControl.Drawing.RectF(((float)(520)), ((float)(0)), ((float)(40)), ((float)(40)));
      ...
      this.currentUser1.Bounds = new NxtControl.Drawing.RectF(((float)(500)), ((float)(40)), ((float)(100)), ((float)(40)));
      ...
      // StartCanvas_2
      // 
      this.Bounds = new NxtControl.Drawing.RectF(((float)(0)), ((float)(0)), ((float)(600)), ((float)(600)));
